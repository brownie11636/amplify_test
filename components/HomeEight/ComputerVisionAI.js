...
export default class ComputerVisionAI extends Component {
  render() {
    return <>
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 col-md-12">
              <div className="creativity-content">
                <h3>
                  Power your Creativity With <span>Computer Vision AI</span>{" "}
                ...
                <div className="skill-bar">
                  ...
                  <div className="progress-content-outter">
                    <div className="progress-content" style={{ width: '65%' }}></div>
                  </div>
                </div>
