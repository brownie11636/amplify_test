  ...
  return (
    <div className="p-[1.875rem] w-fit h-fit bg-white relative ">
      <div className="flex flex-col">
        <div>
          <label htmlFor="view1">
            <input type="radio" name="view" id="view1" className="peer hidden" />
        ...
        <button className="w-[17.5rem] h-[2.5rem] mt-[1.875rem] bg-[#182A5B] flex justify-center items-center">
...
// 40px convert to rem = 2.5rem
// 120px convert to rem = 7.5rem
