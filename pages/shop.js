                        ...
                        <div className="row">
                            <div className="col-lg-4 col-md-6 col-sm-6">
                                <div className="single-product-box">
                                    <div className="product-image">
                                        ...
                                        <a href="/cart" className="add-to-cart-btn">Add To Cart <i className="fas fa-cart-plus"></i></a>
                                    </div>

                                    <div className="product-content">
                                        <h3><a href="/single-products">White Book</a></h3>
                                        <div className="price">
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6">
                                <div className="single-product-box">
                                    ...
                                    <div className="product-content">
                                        <h3><a href="/single-products">Red Side Book</a></h3>
                                        <div className="price">
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6">
                                <div className="single-product-box">
                                    ...
                                    <div className="product-content">
                                        <h3><a href="/single-products">Book With Pen</a></h3>
                                        <div className="price">
                                            <span className="new">$8.50</span>
                                            <span className="old">$12.50</span>
                                        </div>
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6">
                                <div className="single-product-box">
                                    ...
                                    <div className="product-content">
                                        <h3><a href="/single-products">Drop Side Book</a></h3>
                                        <div className="price">
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6">
                                <div className="single-product-box">
                                    ...
                                    <div className="product-content">
                                        <h3><a href="/single-products">Color Book</a></h3>
                                        <div className="price">
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6">
                                <div className="single-product-box">
                                    ...
                                    <div className="product-content">
                                        <h3><a href="/single-products">Last Book</a></h3>
                                        <div className="price">
