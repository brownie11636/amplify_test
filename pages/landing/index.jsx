...
const landingPage = () => {
  return (
    <div className="landing-page w-screen h-fit flex flex-col">
      <div className="w-full h-[68rem] relative">
      ...
      <div className="w-full h-[68rem] flex flex-col justify-center items-center px-[130px]">
        ...
        <div className="flex gap-[100px]">
          <div className="flex flex-col relative pl-[76px]">
            ...
            <span className="text-[34px] text-[#252525] leading-[46.31px] whitespace-pre-wrap z-10 mb-[90px]">
              {`초저지연 통신을 통해 사용자의\n모션에 위하감 없이 동기화됩니다.\n위험하거나 멀리 있는 현장의\n노동자를 대체합니다.`}
            </span>
            <div className="w-[120px] h-[120px] bg-[#CCD4E8] z-0 absolute left-[52px] top-[130px]" />
          </div>
          <picture className="relative w-[51.67vw] h-[51.67vh] ">
            <Image src={`/images/landing/robot-1.svg`} fill alt="" style={{ objectFit: "cover" }} />
          </picture>
        </div>
      </div>
      <div className="w-full h-[68rem] bg-[#F3F3F3] flex flex-col gap-[100px] justify-center px-[130px]">
        <div className="flex gap-[76px]">
          <picture className="w-[800px] h-[450px] relative">
            <Image src={`/images/landing/robot-2.svg`} fill alt="" style={{ objectFit: "cover" }} />
          </picture>
          <div className="flex flex-col">
            ...
            <span className="whitespace-pre-wrap text-[36px] text-[#252525] leading-[49.03px] mb-[83px]">
      ...
      <div className="w-full h-[68rem] pt-[170px]">
        <div className="flex flex-col gap-[44px] px-[148px]">
          <picture className="relative w-[300px] h-[74px] flex">
            <Image src={`/images/landing/logo.svg`} alt="" fill style={{ objectFit: "cover" }} />
          </picture>
          <span className="whitespace-pre-wrap text-[50px] text-[#161616] leading-[68.1px] ml-[30px]">
      ...
      <div className="w-full h-[24rem] bg-[#F3F3F3] flex flex-col justify-center items-center">
        <picture className="relative w-[300px] h-[74px] flex">
          <Image src={`/images/landing/logo.svg`} alt="" fill style={{ objectFit: "cover" }} />
        </picture>
...
const IconsComponent = ({ icon, title }) => {
  return (
    <button className="w-[200px] h-[240px] flex flex-col justify-center items-center bg-white gap-[26px] select-none">
      <picture className="relative w-[60px] h-[60px]">
        <Image src={icon} alt="" fill style={{ objectFit: "cover" }} />
      </picture>
...
const LogosComponent = ({ logo }) => {
  return (
    <div className="w-[480px] h-[120px] flex justify-center items-center bg-[#CCD4E880] relative">
      <span className="uppercase text-white text-[50px]">
        {logo ? <Image src={logo} alt="" fill style={{ objectFit: "cover" }} /> : "logo"}
      </span>
    </div>
  );
};
